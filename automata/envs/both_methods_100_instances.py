...
instances = 25
for inst in range(instances, instances+75):  
#for inst in range(instances):      
    ...
    for k in range(cases):
        print("case: ",str(k+1))
        with open('testes_mesa/'+dataname+'/'+str(inst+1)+'/case'+str(k+1)+'.csv', newline='') as csvfile:
...
#path = "C:/Users/Lucas/Google Drive/Pesquisa/TCC/automata_gym_cont/automata/envs/dados_lucas_100/out1_novo.csv"

#path = "C:/Users/Lucas/Google Drive/Pesquisa/TCC/automata_gym_cont/automata/envs/dados_lucas_100/out2.csv"

#path = "C:/Users/Lucas/Google Drive/Pesquisa/TCC/automata_gym_cont/automata/envs/dados_lucas_100/out3.csv"
