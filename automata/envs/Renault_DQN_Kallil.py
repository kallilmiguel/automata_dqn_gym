...
actions = {}
with open('./testes/'+dataname+'/case1.csv', newline='') as file:
...
writer = SummaryWriter(comment=f"/DQN_{ENV_NAME}:dataname={dataname}_n={N_STEPS}_lr={LEARNING_RATE}_gamma={GAMMA}")
