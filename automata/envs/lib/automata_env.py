...
#from automata.envs.pygv import plotSM
from automata.envs.lib.XMLReader import parse
...
class automataEnv(gym.Env):
  ...
  def step(self, action):
      ...
      indexes = self.binary_search_transitions() # pega todasas açoes
      for index in indexes: 
          if(self.transitions[index][2] == action): # verifica se cada ação equivale à açao de parametro
            #print("Transição Válida")
